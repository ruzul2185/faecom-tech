          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-6 left-6 bg-[#ff6041] rounded-2xl p-6 text-white max-w-xs shadow-xl">
                ...
                <p className="text-sm leading-relaxed">Transform your business with our cutting-edge SAP ERP solutions and expert guidance.</p>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-[#ff6041] text-lg font-semibold tracking-wide">SAP Services</span>
              </div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                This approach encompasses SAP implementation, customization, and integration, offering customized solutions
                to drive impactful results and long-term success in enterprise resource planning.
              </p>

              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                A full suite of services designed to enhance enterprise operations, boost financial visibility, and implement
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our services go beyond traditional ERP solutions—offering innovative, data-driven, and tailored strategies
              to help your business thrive in enterprise resource landscape.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide end-to-end SAP services covering all aspects of ERP implementation and optimization.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We leverage the full power of SAP ecosystem to deliver comprehensive ERP solutions.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We follow a structured approach to ensure successful SAP implementation and optimization.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Let's discuss how we can help you leverage the power of SAP to accelerate your business growth
              and achieve your ERP objectives.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
