...
const AWSService = () => {
  ...
  return (
    <div ref={container} className="min-h-screen ">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="main-left relative">
              <picture>
                <source
                  srcSet="https://res.cloudinary.com/dlvjnevcw/image/upload/v1771568377/aws_g5is6d.avif"
                  type="image/avif"
                />
                <source
                  srcSet="https://res.cloudinary.com/dlvjnevcw/image/upload/v1771568379/aws_qlhjhe.webp"
                  type="image/webp"
                />
                <img
                  loading="lazy"
                  src="https://res.cloudinary.com/dlvjnevcw/image/upload/v1771568379/aws_orzg4c.png"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center flex flex-col items-center ">
            ...
            <p className="partner-subtext text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            ...
            <p className="partner-subtext text-lg text-gray-600 max-w-3xl mx-auto mb-12">
      ...
      <section ref={featuresRef} className="bg-gray-50 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="features-heading text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {AWS_SERVICE_DATA.servicesFeatures.map((feature, index) => (
              <div
                key={index}
                className="features-card bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300"
              >
      ...
      <section ref={techRef} className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="tech-subtext text-gray-600 text-xl max-w-3xl mx-auto">
      ...
      <section ref={ctaRef} className="bg-gray-900 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="cta-subtext text-gray-300 text-xl max-w-3xl mx-auto mb-8">
