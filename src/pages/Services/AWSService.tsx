...
import { FaAws, FaCloud, FaShieldAlt, FaCogs, FaRocket, FaCheckCircle, FaHandshake, FaServer, FaChartLine, FaCode, FaDatabase, FaGlobe, FaLock, FaMobileAlt, FaBolt, FaChartBar } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* Floating elements */}
          <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full filter blur-xl opacity-15 animate-pulse"></div>
          <div className="absolute bottom-1/3 left-1/3 w-48 h-48 bg-gradient-to-br from-green-500 to-teal-500 rounded-full filter blur-2xl opacity-10 animate-bounce"></div>
        </div>
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-4 mb-8">
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl blur-lg opacity-50 animate-pulse"></div>
                <div className="relative w-20 h-20 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center shadow-2xl transform hover:scale-110 transition-all duration-500">
                  <FaAws className="w-10 h-10 text-white animate-pulse" />
                </div>
              </div>
              <div className="text-left">
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 bg-clip-text text-transparent mb-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-orange-600 uppercase tracking-wider">Cloud Excellence</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                to="/contact"
                className="group relative overflow-hidden bg-gradient-to-r from-orange-500 to-red-600 hover:from-red-600 hover:to-orange-500 text-white font-bold py-5 px-10 rounded-2xl transition-all duration-500 transform hover:scale-105 shadow-2xl hover:shadow-3xl inline-flex items-center justify-center gap-3"
              >
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img
                src="https://images.unsplash.com/photo-1451187580-8fc9-4f73-850e345e0e8?auto=format&fit=crop&w=800&q=80"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="relative mb-6">
                <img
                  src="https://images.unsplash.com/photo-1467232180-8d18-4f79-8e8c0d7a4?auto=format&fit=crop&w=600&q=80"
