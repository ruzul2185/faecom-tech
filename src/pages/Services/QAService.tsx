import { FaBug, FaShieldAlt, FaTachometerAlt, FaCheckCircle, FaRobot, FaSearch, FaCog, FaMobileAlt, FaCloud, FaLock } from "react-icons/fa";
...
const QAService = () => {
  const getIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'tachometer': return <FaTachometerAlt />;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img
                src="https://images.unsplash.com/photo-1555947230-8d18-4f79-8e8c0d7a4?auto=format&fit=crop&w=800&q=80"
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-[#ff6041] text-lg font-semibold tracking-wide">QA Services</span>
              </div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Our comprehensive QA approach encompasses manual testing, automation, and performance testing,
                offering customized solutions to ensure your software meets the highest quality standards.
              </p>

              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                A full suite of testing services designed to enhance software reliability, boost performance,
                and implement quality strategies tailored to meet the unique needs of your business.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our QA services go beyond traditional testing—offering innovative, comprehensive, and tailored strategies
              to ensure your software delivers exceptional user experience.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide end-to-end quality assurance services covering all aspects of software testing.
            </p>
          </div>
      ...
      <section className="bg-gray-50 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Beyond our core services, we offer specialized testing solutions to meet all your quality assurance needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="relative mb-6">
                <img
                  src="https://images.unsplash.com/photo-1555947230-8d18-4f79-8e8c0d7a4?auto=format&fit=crop&w=600&q=80"
              ...
              {QA_SERVICE_DATA.additionalCapabilities.slice(0, 3).map((capability, index) => (
                <div key={index} className="flex items-start gap-3">
                  <FaCheckCircle className="w-4 h-4 text-[#ff6041] shrink-0 mt-1" />
            ...
            <div className="space-y-8">
              ...
              {QA_SERVICE_DATA.additionalCapabilities.slice(3).map((capability, index) => (
                <div key={index} className="flex items-start gap-3">
                  <FaCheckCircle className="w-4 h-4 text-[#ff6041] shrink-0 mt-1" />
                  <span className="text-gray-700 leading-relaxed">{capability}</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We follow a structured approach to ensure comprehensive software quality assurance.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We leverage industry-leading tools and technologies to deliver comprehensive testing solutions.
            </p>
          </div>
      ...
      <section className="bg-gray-50 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Partner with us to enhance your software quality and drive business success.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Let's discuss how we can help you implement comprehensive QA strategies to deliver
              flawless software experiences to your users.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
