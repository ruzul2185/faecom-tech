...
import { FaFileContract, FaShieldHalved, FaUserShield, FaCreditCard, FaGavel, FaEnvelope, FaChevronDown } from "react-icons/fa6";
  ...
  const sections = [
    {
      ...
      content: {
        description: "These terms and conditions govern your use of FaecomTech's services and website.",
        points: [
    ...
    },
    {
      ...
      content: {
        description: "Terms specific to FaecomTech's IT services, consulting, and training programs.",
        points: [
    ...
    },
    {
      ...
      content: {
        description: "How we collect, use, and protect your personal and business information.",
        points: [
    ...
    },
    {
      ...
      content: {
        description: "Your responsibilities when using FaecomTech's services and platform.",
        points: [
    ...
    },
    {
      ...
      content: {
        description: "Payment terms, billing cycles, and financial arrangements.",
        points: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Please read these terms carefully before using FaecomTech's services and platform.
            </p>
      ...
      <section className="bg-gray-900 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact">
                <PrimaryButton title="Contact Legal Team" classname="rounded-[25px]" />
              </a>
