...
const SAPTraining = () => {
  ...
  useGSAP(
    () => {
      ...
      gsap.from(".collaboration-heading", {
        y: 40,
        opacity: 0,
        duration: 0.8,
        ease: "power3.out",
  ...
  return (
    <div ref={container} className="flex flex-col gap-24 mt-30 mb-30">
      ...
      <section
        ...
        className="max-w-7xl mx-auto px-6 py-16 bg-linear-to-r from-blue-50 to-indigo-50 rounded-[40px]"
      >
        <div className="text-center">
          <h2 className="collaboration-heading text-3xl lg:text-4xl font-bold mb-8">
          ...
          <div className="flex justify-center items-center gap-8 mb-8">
            ...
            >
              <img
                ...
                className="collaboration-logo h-16"
              />
            </a>
          ...
          <p className="collaboration-text text-lg text-gray-600 max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="overview-image relative overflow-hidden rounded-[25px]">
              <picture>
                ...
                />
                <source
                  srcSet={sapTrainingDetails.images.overviewWebp}
                  type="image/webp"
                />
                <img
                  loading="lazy"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="learning-image relative overflow-hidden rounded-[25px]">
              <picture>
                ...
                />
                <source
                  srcSet={sapTrainingDetails.images.learningOutcomesWebp}
                  type="image/webp"
                />
                <img
                  loading="lazy"
      ...
      {/* ================= TECH STACK SECTION ================= */}
      <section ref={techStackRef} className=" py-20 lg:py-3 bg-black">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              {sapTrainingDetails.practicalApproach.methodologies.map(
                (method, index) => (
                  <div
                    key={index}
          ...
          <div className="practical-image relative overflow-hidden rounded-[25px]">
            <picture>
              ...
              />
              <source
                srcSet={sapTrainingDetails.images.practicalApproachWebp}
                type="image/webp"
              />
              <img
                loading="lazy"
