...
import { HiOutlineGlobeAlt, HiOutlineLightningBolt, HiOutlineTag,  } from "react-icons/hi";
import { HiOutlineBriefcase, HiOutlineTrophy, HiOutlineUser, HiOutlineRocketLaunch  } from "react-icons/hi2";
    ...
    <div className="flex flex-col items-stretch gap-24 mt-30 mb-30">
      ...
      <section className="max-w-5xl mx-auto text-center flex flex-col gap-6.75 justify-center items-center">
        ...
        <div className="text-4xl sm:text-[64px] font-medium">
          ...
          <span>Training</span>{" "}
          <span className="text-[#ff6041]">Programs</span>
        </div>
        <div className="text-[14px] sm:text-[20px]/[40px] w-[90%] font-medium text-[#7e7e7e] max-w-226">
          <p>
            We deliver enterprise-level training programs designed for real-world implementation,
            practical exposure, and long-term career growth.
          </p>
        </div>
      </section>
            ...
            <div className=" lg:mt-20 grid grid-cols-2 max-w-442.5 w-[93%] mx-auto md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={index} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                  <div className="text-3xl font-bold text-[#ff6041] mb-1">{stat.number}</div>
        ...
        <div className="bg-white rounded-[40px] shadow-xl overflow-hidden grid lg:grid-cols-2">
          ...
          <div className="p-10 sm:p-16 flex flex-col items-start justify-center">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              learners gain hands-on experience, real-time server access,
              and exposure to live implementation environments.
            </p>
           ...
           <a href="https://skils.in">
            <PrimaryButton title="Visit SKILS.in" classname="rounded-[25px]" />
          </a>
  ...
  <div className="space-y-28">
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Our SAP programs are designed to provide in-depth functional and technical
          knowledge aligned with real-time business processes. Learners gain
          hands-on experience in implementation, configuration, and support
          scenarios that reflect real corporate environments.
        </p>

        {/* Functional Modules */}
        <div className="mb-6">
          <h4 className="font-semibold text-lg mb-3">SAP Functional Modules</h4>
          <p className="text-gray-600 mb-3">
            Our functional training focuses on core business operations and enterprise
        ...
        {/* Technical Modules */}
        <div className="mb-6">
          <h4 className="font-semibold text-lg mb-3">SAP Technical Modules</h4>
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          implementation-based learning, we prepare candidates to confidently
          handle SAP projects across industries.
        </p>

        <PrimaryButton title="Explore SAP Modules" classname="rounded-[25px]" />
      </div>
    </div>
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      <div className="order-2 lg:order-1">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Our cloud training programs are built around the powerful ecosystem
          of Amazon Web Services. We provide comprehensive knowledge of cloud
          architecture, deployment strategies, and secure infrastructure
          management.
        </p>
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          automation, and scalable cloud solutions that meet industry demands.
        </p>

        <PrimaryButton title="Explore AWS Program" classname="rounded-[25px]" />
      </div>
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          customizing, and integrating Zoho tools to streamline
          business operations.
        </p>
        ...
        <PrimaryButton title="Explore Zoho Program" classname="rounded-[25px]" />
      </div>
    </div>
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      <div className="order-2 lg:order-1">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          to develop expertise in CRM solutions, automation, and
        ...
        <PrimaryButton title="Explore Salesforce Program" classname="rounded-[25px]" />
      </div>
          ...
          <div className="relative">
            ...
            <div className="text-center mb-20">
              <div className="inline-flex items-center gap-2 bg-white border-2 border-[#ff6041]/20 px-8 py-4 rounded-full mb-8 shadow-sm">
                ...
                <span className="text-[#ff6041] font-semibold text-lg">Why Choose Our Training</span>
              </div>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Discover what sets our training programs apart and why professionals
                worldwide choose us for their career transformation
              </p>
            </div>
  ...
  {[
    {
      ...
      description: "Stay ahead with training designed for real-world applications and current industry demands",
      icon: HiOutlineTag,
    },
    {
      title: "Hands-On Learning",
      description: "Learn by doing with practical projects, real-time scenarios, and live implementations",
      icon: HiOutlineLightningBolt,
    },
    {
      title: "24/7 Lab Access",
      description: "Practice on dedicated servers with round-the-clock access for uninterrupted learning",
      icon: MdOutlineDesktopMac,
    },
    {
      title: "Expert Mentors",
      description: "Learn from certified professionals with years of industry experience and real-world insights",
      icon: HiOutlineUser,
    },
    {
      title: "Live Projects",
      description: "Work on live projects that mirror corporate environments and real business challenges",
      icon: HiOutlineRocketLaunch ,
    },
    {
      title: "Career Support",
      description: "Get personalized career counseling, interview preparation, and job placement assistance",
      icon: HiOutlineGlobeAlt,
    },
    {
      title: "Placement Network",
      description: "Access to exclusive placement network with 500+ corporate partners worldwide",
      icon: HiOutlineBriefcase,
    },
    {
      title: "Certifications",
      description: "Industry-recognized certifications that validate your skills and boost your career",
    ...
    <div key={index} className="group">
      ...
      <section className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl font-bold mb-6">
          Ready to <span className="text-[#ff6041]">Transform</span> Your Career?
        </h2>
        <p className="text-lg w-[90%] mx-auto text-gray-700 mb-8">
          Join professionals who accelerate their careers through
          structured, implementation-driven training.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <SecondaryButton title="Start Learning Today" classname="rounded-[25px]" />
        </div>
      </section>
