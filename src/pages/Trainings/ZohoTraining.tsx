        ...
        <div className="bg-linear-to-r from-gray-50 to-white rounded-3xl p-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <img
                src={zohoTrainingDetails.images.overview}
            ...
            <div>
              ...
              <div className="text-gray-600 text-lg leading-relaxed space-y-4">
                {zohoTrainingDetails.overview.split('\n\n').map((paragraph, index) => (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              {zohoTrainingDetails.practicalApproach.methodologies.map((method, index) => (
                <div key={index} className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                    <span className="text-green-600 text-sm">✓</span>
                  </div>
    ...
    {zohoTrainingDetails.whyChooseUs.map((reason, index) => (
      ...
      <section className="max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="text-gray-600 text-lg mb-8 max-w-3xl mx-auto">
          Join thousands of professionals who have transformed their careers with our industry-leading Zoho training program.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <PrimaryButton title="Start Your Zoho Journey"  classname="rounded-[25px]" />
